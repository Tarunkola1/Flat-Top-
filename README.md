...
## Tools required
1.Python: A versatile programming language used for scientific computing and signal processing. 2.NumPy: A powerful numerical library in Python for performing array-based operations and mathematical computations. 3.Matplotlib: A plotting library for generating high-quality graphs and visualizations of data, essentialfor demonstrating the sampling process.
...
```
## Output Waveform
![image](https://github.com/user-attachments/assets/773073c3-1f48-423f-adfb-605430bd4bf8)
...
![WhatsApp Image 2025-05-07 at 20 36 48_74263aad](https://github.com/user-attachments/assets/4041bcc6-60b9-4811-b671-23b0776d9176)
